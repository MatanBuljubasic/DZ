...
namespace Classlibrary
{
    ...
    public class Weather
    {
        ...
        public double CalculateWindChill() { if (GetTemperature() <= 10 && GetWindSpeed() > 4.8) return 13.12 + 0.6215 * GetTemperature() - 11.37 * Math.Pow(GetWindSpeed(), 0.16) + 0.3965 * GetTemperature() * Math.Pow(GetWindSpeed(), 0.16);
            else return 0;
        }
